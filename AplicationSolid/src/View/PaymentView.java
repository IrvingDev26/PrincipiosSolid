...
import java.text.DecimalFormat; // Importación necesaria para el documento del campo de monto

/**
 * La Vista de la aplicación, responsable de mostrar la interfaz de usuario
 * y recolectar la entrada del usuario.
 * Implementa IPaymentView para permitir la Inversión de Dependencias.
 * Cumple con el Principio de Responsabilidad Única (S) al encargarse solo de la UI.
 * Ahora utiliza UIFactory para la creación y estilización de componentes.
 */
public class PaymentView extends JFrame implements IPaymentView { // Implementa IPaymentView
    ...
    public PaymentView() {
        ...
        setSize(450, 480); // Un poco más de altura para mejor estética
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLocationRelativeTo(null);
        setLayout(new BorderLayout(15, 15)); // Más espaciado entre componentes
        getContentPane().setBackground(UIFactory.getSecondaryColor()); // Fondo general

        // Panel superior para el monto y selección de método
        JPanel topPanel = new JPanel(new GridLayout(2, 2, 10, 10)); // Más espaciado
